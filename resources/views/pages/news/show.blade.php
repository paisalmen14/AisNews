...
<!-- Detail Berita -->
  <div class="flex flex-col px-4 lg:px-14 mt-10">
    ...
    <div class="flex flex-col lg:flex-row w-full gap-10">
      <!-- Berita Utama -->
      <div class="lg:w-8/12">
        <img src="{{ asset('storage/' . $news->thumbnail) }}" alt="Berita Utama" class="w-full max-h-96 rounded-xl object-cover">
      ...
      <div class="lg:w-4/12 flex flex-col gap-10">
        <div class="sticky top-24 z-40 flex flex-col gap-5">
          <p class="font-bold mb-2 text-xl lg:text-2xl">Berita Terbaru Lainnya</p>
          <!-- Berita Card -->
              ...
              <div class="flex gap-3 border border-slate-300 hover:border-primary p-3 rounded-xl">
                ...
                <div class="flex gap-3 flex-col lg:flex-row">
                  ...
                  <div class="">
                    ...
                    <p class="text-slate-400 mt-2 text-sm lg:text-xs">{{ \Str::Limit($new->content, 100) }} </p>
                  </div>
                </div>
              </div>
            </a>
